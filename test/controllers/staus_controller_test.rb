...
class StausControllerTest < ActionController::TestCase
  ...
  test "should create stau" do
    assert_difference('Stau.count') do
      post :create, stau: { content: @stau.content, name: @stau.name, string: @stau.string, text: @stau.text }
    end
  ...
  test "should update stau" do
    patch :update, id: @stau, stau: { content: @stau.content, name: @stau.name, string: @stau.string, text: @stau.text }
    assert_redirected_to stau_path(assigns(:stau))
  end
